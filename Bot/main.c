...
int main(int argc, char *argv[]) {
    ...
    insertAndSetFirstWall(&head, 2,  OVERALL_WINDOW_WIDTH/2 - 45, OVERALL_WINDOW_HEIGHT/2+100, 7, OVERALL_WINDOW_HEIGHT/2-100);
    insertAndSetFirstWall(&head, 3,  OVERALL_WINDOW_WIDTH/2-45, OVERALL_WINDOW_HEIGHT/2+100, 150, 7);
    insertAndSetFirstWall(&head, 2,  OVERALL_WINDOW_WIDTH/2 + 100, OVERALL_WINDOW_HEIGHT/2 - 50, 7, 157);
    insertAndSetFirstWall(&head, 2,  OVERALL_WINDOW_WIDTH/2-150, OVERALL_WINDOW_HEIGHT/2 - 50, 250, 7);
    insertAndSetFirstWall(&head, 2,  OVERALL_WINDOW_WIDTH/2 - 150, OVERALL_WINDOW_HEIGHT/2-50, 7, OVERALL_WINDOW_HEIGHT/2-100);
    insertAndSetFirstWall(&head, 3,  OVERALL_WINDOW_WIDTH/2-320, OVERALL_WINDOW_HEIGHT/2+90, 177, 7);
